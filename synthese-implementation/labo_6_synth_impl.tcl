...
# Ensuite naviguer dans le bon répertoire, par exemple user\docs\poly\inf3500\labo5\synthese-implementation
#
...
read_vhdl -vhdl2008 ../solution-etc/PolyRISC_v10b_solution.vhd
read_vhdl -vhdl2008 ../sources/PolyRISC_utilitaires_pkg.vhd
#read_vhdl -vhdl2008 ../sources/PolyRISC_le_programme_pkg.vhd
read_vhdl -vhdl2008 ../solution-etc/PolyRISC_le_programme_pkg_solution.vhd
...
# choisir les trois lignes qui correpondent à votre carte
